...
def train(args):
    print(f"Starting training for Shadow Model: {args.model_id}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/phi4_lora")
    parser.add_argument("--max_steps", type=int, default=300)
    parser.add_argument("--batch_size", type=int, default=1)
    parser.add_argument("--lr", type=float, default=2e-4) # Slightly higher for smaller component models usually, but keep standard
